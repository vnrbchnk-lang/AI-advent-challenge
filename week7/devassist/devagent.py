...
SYSTEM = (
    ...
    "2а) Если вопрос про устройство челленджа (недели, дни, правила, расписание) — начни с CLAUDE.md, "
    "там контекст и правила. Соответствие дней неделям бери из заголовков журналов "
    "(«дни 1–5», «дни 6–10» и так далее), а не из общих соображений о календаре.\n"
