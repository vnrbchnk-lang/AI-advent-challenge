...
DIMENSIONS = [
    {
        ...
        "system": COMMON_RULES + " Твоя специализация — ошибки: краши, None и пустые значения, "
                                 "неверные условия и границы, необработанные исключения, утечки ресурсов, "
                                 "гонки, неверная обработка ошибок API.",
        "query": "обработка ошибок, граничные случаи, известные баги",
    },
    {
        "key": "architecture",
    ...
    },
    {
        ...
        "system": COMMON_RULES + " Твоя специализация — писаные правила проекта: конвенции кода, "
                                 "запреты, требования к секретам и ключам, стиль, требования к оформлению. "
                                 "Каждое замечание обязано ссылаться на конкретное правило из фрагментов.",
        "query": "правила и конвенции разработки, ограничения для агента, требования к коду",
    },
]
